import { c, b, f, j, i, g, e, h, m, o, p, r, a, d, t } from "./index-BNq_n_5e.mjs";
...
const isBigIntChanged = (a2, b2, tolerance = parseUnits("0.0001", 18)) => {
  return bigintAbs(a2 - b2) > tolerance;
};

import { defineChain as defineChain$1, parseUnits, encodeFunctionData, formatUnits, isHex as isHex$1, zeroAddress, concatHex as concatHex$1, toHex as toHex$1 } from "viem";
import { h as hexToNumber, t as toHex, a as hexToBytes, b as bytesToHex, c as toBytes, i as isHex, B as BaseError, s as size, d as createCursor, I as InvalidChainIdError, e as isAddress, f as InvalidAddressError, m as maxUint256, F as FeeCapTooHighError, T as TipAboveFeeCapError, g as slice, j as InvalidSerializableTransactionError, k as InvalidStorageKeySizeError, n as numberToHex, l as concatHex, o as toRlp, p as InvalidLegacyVError, q as trim, r as hexToBigInt } from "./index-DEF8B5xX.mjs";
import { w, y, x, u, v } from "./index-DEF8B5xX.mjs";
import { s as sha256$2 } from "./sha2-BLf4ZO_9.mjs";
...
const bigintMax = (...args) => {
  return args.filter((x2) => !isUndefined(x2)).reduce((max, cur) => cur > max ? cur : max);
};
const bigintMin = (...args) => {
  return args.filter((x2) => !isUndefined(x2)).reduce((min, cur) => cur < min ? cur : min);
};
...
function toRpcUserOpCanonical(op) {
  const hx = (v2) => typeof v2 === "string" && isHex$1(v2) ? v2 : toHex$1(BigInt(v2 || "0"));
...
export {
  ...
  bigintRound,
  bigintifyNumbers,
  w as composeRollupsContracts,
  createAbiEncoder,
  createComposeConfig,
  y as createUserOp,
  x as encodeXtMessage,
  u as entryPointV07,
  ethFormatter,
  extractAbiFunction,
  formatBigintInput,
  ...
  rollupA,
  rollupB,
  v as rollupsAccountAbstractionContracts,
  roundOperatorFee,
  sortNumbers,
  stringifyBigints,
